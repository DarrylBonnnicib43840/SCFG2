...
public class snakeGenerator : MonoBehaviour
{
    ...
    GameObject playerBox,breadcrumbBox,pathParent,timerUI, EndPoint, Obsticle,Obsticle2;
	...
	int randomNum,randomNumBottom,randomNumLeft,randomNumRight,randomNumTop,randomNumY,randomNumY2;
    ...
    void Start()
    {
		...
		randomNumLeft = Random.Range(-6,-3);
		randomNumRight = Random.Range(4,6);
		
		randomNumY = Random.Range(-5,5);
		randomNumY2 = Random.Range(-5,5);
